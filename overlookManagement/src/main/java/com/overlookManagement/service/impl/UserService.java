...
import com.overlookManagement.dto.UserDTO;
...
import com.overlookManagement.service.interfac.IUserService;
import com.overlookManagement.utils.JWTUtils;
...
public class UserService implements IUserService {
    ...
    public Response login(LoginRequest loginRequest) {
        ...
        try {
            ...
            response.setMessage("Error during User Login");
        }
        return response;
    }
    ...
    public Response getMyInfo(String email) {
        ...
        try {
            ...
            response.setStatusCode(500);
            response.setMessage("Error during delete user " + (e.getMessage()));
        }
        return response;
    }
    ...
    public Response getUserBookingHistory(String userId) {
        ...
        try {
            ...
            response.setStatusCode(500);
            response.setMessage("Error during getting all users " + (e.getMessage()));
        }
        return response;
    }
